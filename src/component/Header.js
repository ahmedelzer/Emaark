...
// Menu.map((item)=>{console.log(item.titleAR)})
  return (
    ...
    <button class="navbar-toggler collapsed" onClick={()=>setopen(true)} type="button" data-bs-toggle="collapse" data-bs-target="#main" aria-controls="main" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div class="navbar-collapse collapse show" id="main"><ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            {
             ...
             {return <li class="nav-item" key={index}><a class="nav-link p-2 p-lg-3 active" aria-current="page" title="home" href="/">{item.titleAR}</a></li>}
